export function Menu({ top, bottom, left, right, size }) {
...
export function X({ top, bottom, left, right, size }) {
  const positionStyles = {
    ...(top && { top: `${top}px` }),
    ...(bottom && { bottom: `${bottom}px` }),
    ...(left && { left: `${left}px` }),
...
export function Home({ top, bottom, left, right, size }) {
  const positionStyles = {
    ...(top && { top: `${top}px` }),
    ...(bottom && { bottom: `${bottom}px` }),
    ...(left && { left: `${left}px` }),
...
export function Grade({ top, bottom, left, right, size }) {
  const positionStyles = {
    ...(top && { top: `${top}px` }),
    ...(bottom && { bottom: `${bottom}px` }),
    ...(left && { left: `${left}px` }),
...
export function Attendance({ top, bottom, left, right, size }) {
  const positionStyles = {
    ...(top && { top: `${top}px` }),
    ...(bottom && { bottom: `${bottom}px` }),
    ...(left && { left: `${left}px` }),
...
export function Info({ top, bottom, left, right, size }) {
  const positionStyles = {
    ...(top && { top: `${top}px` }),
    ...(bottom && { bottom: `${bottom}px` }),
    ...(left && { left: `${left}px` }),
...
export function Settings({ top, bottom, left, right, size }) {
  const positionStyles = {
    ...(top && { top: `${top}px` }),
    ...(bottom && { bottom: `${bottom}px` }),
    ...(left && { left: `${left}px` }),
...
export function User({ top, bottom, left, right, size }) {
  const positionStyles = {
    ...(top && { top: `${top}px` }),
    ...(bottom && { bottom: `${bottom}px` }),
    ...(left && { left: `${left}px` }),
